...
if("TRUE" STREQUAL "TRUE")
  set(my_pcl_tutorial_SOURCE_PREFIX /home/leon/graspdemo/src/my_pcl_tutorial)
  set(my_pcl_tutorial_DEVEL_PREFIX /home/leon/graspdemo/devel)
  ...
  set(my_pcl_tutorial_INSTALL_PREFIX /home/leon/graspdemo/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'my_pcl_tutorial' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'leon <zhanghengsjtu@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'my_pcl_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/leon/graspdemo/src/my_pcl_tutorial/${idir}'.  Ask the maintainer 'leon <zhanghengsjtu@gmail.com>' to fix it.")
    endif()
